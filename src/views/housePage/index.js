...
export default class index extends Component {
    ...
    async componentDidMount() {
        ...
        const house = await axios.get(`http://localhost:5000/house/params/${house_id}`)
        const relatedHouses = await axios.get(`http://localhost:5000/house/search/${house.data.city}`)
        this.setState({
            house : house.data,
